...
impl super::super::Cpu {
    pub fn bit_n_set_hl(&mut self, bit_n: u8) -> ClockCycle {
    ...
    pub fn bit_n_set_r8(&mut self, register: &CpuRegister, bit_n: u8) -> ClockCycle {
    ...
    pub fn res_hl(&mut self, bit_n: u8) -> ClockCycle {
        let address = self.registers.get_target_16(&CpuRegister16::HL);
        let value = self.mmu.read_byte(address);
    ...
    pub fn res_r8(&mut self, register: &CpuRegister, bit_n: u8) -> ClockCycle {
        let value = self.registers.get_target(register);
    ...
    pub fn set_hl(&mut self, bit_n: u8) -> ClockCycle {
        let address = self.registers.get_target_16(&CpuRegister16::HL);
        let value = self.mmu.read_byte(address);
    ...
    pub fn set_r8(&mut self, register: &CpuRegister, bit_n: u8) -> ClockCycle {
        let value = self.registers.get_target(register);
    ...
    pub fn srl_hl(&mut self) -> ClockCycle {
        let address = self.registers.get_target_16(&CpuRegister16::HL);
        let value = self.mmu.read_byte(address);
    ...
    pub fn srl_r8(&mut self, register: &CpuRegister ) -> ClockCycle {
        let register_value = self.registers.get_target(register);
    ...
    pub fn swap_hl(&mut self) -> ClockCycle {
        let address = self.registers.get_target_16(&CpuRegister16::HL);
        let value = self.mmu.read_byte(address);
    ...
    pub fn swap_r8(&mut self, register: &CpuRegister) -> ClockCycle {
        let register_value = self.registers.get_target(register);
